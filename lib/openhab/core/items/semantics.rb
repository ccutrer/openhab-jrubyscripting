...
module Enumerable
  ...
  #
  # @note As `Equipments` are usually GroupItems, this method would therefore return an array of
  #   GroupItems. In order to get the Points that belong to the Equipments, use {#members} before
  #   calling {#points}.
  #
  # @return [Array<GenericItem>]
  #
